export const theme = {
  ...
  shadows: {
    ...
    brandLg: '0 8px 40px rgba(249, 115, 22, 0.5)',
    brandSm: '0 0 15px rgba(249, 115, 22, 0.2)',
  },

  gradients: {
    brand: 'linear-gradient(135deg, #f97316 0%, #c2570a 100%)',
    hero: 'linear-gradient(135deg, #0a0a0f 0%, #1a0f06 50%, #0a0a0f 100%)',
