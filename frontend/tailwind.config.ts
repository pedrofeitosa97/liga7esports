  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'ios-glow': '0 0 30px rgba(249, 115, 22, 0.3)',
        'ios-glow-sm': '0 0 15px rgba(249, 115, 22, 0.2)',
        brand: '0 4px 24px rgba(249, 115, 22, 0.4)',
        'brand-lg': '0 8px 40px rgba(249, 115, 22, 0.5)',
      ...
      backgroundImage: {
        'gradient-brand': 'linear-gradient(135deg, #f97316 0%, #c2570a 100%)',
        'gradient-hero': 'linear-gradient(135deg, #0a0a0f 0%, #1a0f06 50%, #0a0a0f 100%)',
